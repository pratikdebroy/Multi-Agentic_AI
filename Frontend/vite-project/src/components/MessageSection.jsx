...
const MessageSection = () => {
    ...
    <div className="flex flex-col gap-1.5">
        ...
        <h1 className="text-[20px] font-semibold text-slate-200 tracking-tight cortex-reveal">
            Vision AI
        </h1>

        <p className="text-[15px] font-semibold text-slate-400 tracking-tight cortex-reveal-delay">
            How can I help you?
        </p>

        <p className="text-[13px] text-slate-600 max-w-[260px] leading-relaxed cortex-reveal-delay-2">
            Ask me anything — code, ideas, explanations, or just a quick question.
        </p>
        
    </div>
    <div className="flex flex-wrap justify-center gap-2 mt-1 cortex-reveal-delay-2">
